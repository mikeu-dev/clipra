<script lang="ts">
	...
	const form = superForm(
		untrack(() => data.form),
		{
			...
			onUpdated: ({ form: f }) => {
				if (f.valid) {
					toast.success(m.toast_success_account_updated());
				} else {
...
<div class="space-y-6 p-10 pb-16 md:block">
	<div class="space-y-0.5">
		<h2 class="text-3xl font-bold tracking-tight text-blue-900 dark:text-blue-100">Edit Account</h2>
		<p class="text-muted-foreground">Update account details.</p>
	</div>
